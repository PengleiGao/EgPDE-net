...
lr_dic.update( {"elec": 0.01} )
lr_dic.update( {"etth1": 0.01} )
lr_dic.update( {"etth2": 0.01} )
...
target_col_dic.update( {"etth1": 6} )
target_col_dic.update( {"etth2": 6} )
...
indep_col_dic.update( {"etth1": [0,5]} )
indep_col_dic.update( {"etth2": [0,5]} )
...
batch_size_dic.update( {"etth1": 128} )
batch_size_dic.update( {"etth2": 128} )
...
num_epoch_dic.update( {"elec": 100} )
num_epoch_dic.update( {"etth1": 200} )
num_epoch_dic.update( {"etth2": 200} )
